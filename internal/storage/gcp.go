...
import (
	...
	"github.com/terrakube-community/terrakubed/internal/utils"
...
func (s *GCPStorageService) SearchModule(org, module, provider, version, source, vcsType, connectionType, accessToken, tagPrefix, folder string) (string, error) {
...
func (s *GCPStorageService) DownloadModule(org, module, provider, version string) (io.ReadCloser, error) {
	...
	r, err := s.Client.Bucket(s.BucketName).Object(key).NewReader(context.TODO())
	if err != nil {
